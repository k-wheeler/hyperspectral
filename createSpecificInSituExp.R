...
#toDo[,3] <- c(-0.00002,0.00008,-0.00008,-0.000002,-0.1,-0.0001)
...
output <- foreach(i=1:nrow(toDo))%dopar%{
  ...
  if(!file.exists(outFileName)){
    ...
    var.Burn <- runMCMC_Model(j.model=j.model,variableNames = c("a","b","c","prec"),baseNum=150000,iterSize=50000,maxGBR=100,ID=paste(ind,toDo[i,1],sep="_"))
