...
#i=1
trees <- c("PO5","BE5","BI5","BE4","BI4","PO4","BE3","BI3","PO3","PO2","BE2","BI2","PO1","BE1","BI1")
  
#  c("BE1","BE5","PO1","PO2","PO3","PO4","PO5","BE2","BE3","BE4","PO1","BI1","BI2","BI3","BI4","BI5")
year=2016
output <- foreach (i=1:length(trees))%dopar%{
  ...
  if(!file.exists(outFileName)){
    ...
    var.Burn <- runMCMC_Model(j.model=j.model,variableNames = c("a","b","c","prec"),baseNum=50000,iterSize=50000,maxGBR=2,ID=paste(ind,trees[i],sep="_"))
